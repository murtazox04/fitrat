...
_MODEL_PATH = str(Path(__file__).parent / "model" / "langdetect.ftz")
...
class LanguageDetector:
    ...
    def predict(self, text: str) -> tuple[str, ...]:
        ...
        Returns:
                tuple: containing the predicted language labels.
        """
        label, _ = self.model.predict(text)  # type: ignore[no-untyped-call]
